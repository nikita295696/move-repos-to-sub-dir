...
function mainPageInit() {
    ...
    setInterval(function (e) {
        switch (location.hash) {
            case '#section2':
                $("a.arrow-down_bottom1").hide(500);
                $("a.arrow-down_bottom2").show(500);
                break;
            case '#section3':
                $("a.arrow-down_bottom1").hide(500);
                $("a.arrow-down_bottom2").hide(500);
                break;
            default:
            case '#section1':
                $("a.arrow-down_bottom1").show(500);
                $("a.arrow-down_bottom2").hide(500);
                break;
        }
...
var revapi = $(document).ready(revapiInit); // revslider
